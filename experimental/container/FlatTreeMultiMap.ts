import { TreeMapElementVector } from "../../internal/container/adaptive/TreeMapElementVector";
...
export class FlatTreeMultiMap<Key, T>
{
    private data_: TreeMapElementVector<Key, T, false, FlatTreeMultiMap<Key, T>> = new TreeMapElementVector(<FlatTreeMultiMap<Key, T>>this);
    ...
    public swap(obj: FlatTreeMultiMap<Key, T>): void
    {
        this.data_.swap(obj.data_);

        const data: TreeMapElementVector<Key, T, true, FlatTreeMultiMap<Key, T>> = this.data_;
...
{
    export type Iterator<Key, T> = TreeMapElementVector.Iterator<Key, T, false, FlatTreeMultiMap<Key, T>>;
    export type ReverseIterator<Key, T> = TreeMapElementVector.ReverseIterator<Key, T, false, FlatTreeMultiMap<Key, T>>;
}