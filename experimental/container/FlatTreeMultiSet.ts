import { TreeSetElementVector } from "../../internal/container/adaptive/TreeSetElementVector";
...
export class FlatTreeMultiSet<Key>
{
    private data_: TreeSetElementVector<Key, false, FlatTreeMultiSet<Key>> = new TreeSetElementVector(<FlatTreeMultiSet<Key>>this);
    ...
    public swap(obj: FlatTreeMultiSet<Key>): void
    {
        this.data_.swap(obj.data_);

        const data: TreeSetElementVector<Key, true, FlatTreeMultiSet<Key>> = this.data_;
...
{
    export type Iterator<Key> = TreeSetElementVector.Iterator<Key, false, FlatTreeMultiSet<Key>>;
    export type ReverseIterator<Key> = TreeSetElementVector.ReverseIterator<Key, false, FlatTreeMultiSet<Key>>;
}