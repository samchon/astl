...
export class FlatTreeSet<Key>
{
    public data_: TreeSetElementVector<Key, true, FlatTreeSet<Key>> = new TreeSetElementVector(<FlatTreeSet<Key>>this);
    ...
    public swap(obj: FlatTreeSet<Key>): void
    {
        this.data_.swap(obj.data_);

        const data: TreeSetElementVector<Key, true, FlatTreeSet<Key>> = this.data_;
...
{
    export type Iterator<Key> = TreeSetElementVector.Iterator<Key, true, FlatTreeSet<Key>>;
    export type ReverseIterator<Key> = TreeSetElementVector.ReverseIterator<Key, true, FlatTreeSet<Key>>;
}