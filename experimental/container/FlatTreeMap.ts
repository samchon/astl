...
export class FlatTreeMap<Key, T>
{
    private data_: TreeMapElementVector<Key, T, true, FlatTreeMap<Key, T>> = new TreeMapElementVector(<FlatTreeMap<Key, T>>this);
    ...
    public swap(obj: FlatTreeMap<Key, T>): void
    {
        this.data_.swap(obj.data_);

        const data: TreeMapElementVector<Key, T, true, FlatTreeMap<Key, T>> = this.data_;
...
{
    export type Iterator<Key, T> = TreeMapElementVector.Iterator<Key, T, true, FlatTreeMap<Key, T>>;
    export type ReverseIterator<Key, T> = TreeMapElementVector.ReverseIterator<Key, T, true, FlatTreeMap<Key, T>>;
}